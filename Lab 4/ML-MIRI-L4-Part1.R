...
# LAB 4: LDA/QDA/RDA, kNN, Naïve Bayes (Part1)
...
# and its sample covariance matrix (the theoretical one is Sigma = M·M^T)

(S <- cov(X))

# and its sample mean (the theoretical one is mu)
